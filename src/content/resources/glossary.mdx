...
<Aside type="danger" title="">
  The adapters or JSON adapters for v1 Jobs are removed for Chainlink nodes running version 1.0.0 and later. Use [v2 job
  tasks](/chainlink-nodes/oracle-jobs/tasks) instead.
</Aside>
...
<Aside type="danger" title="">
  The initiators for v1 Jobs are removed for Chainlink nodes running version 1.0.0 and later. Use the [v2 job
