...
Testnet LINK is available at [faucets.chain.link](https://faucets.chain.link/chapel). Testnet BNB is available at [testnet.binance.org/faucet-smart](https://testnet.binance.org/faucet-smart).
...
| :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ETH_CHAIN_ID` | `8453`                                                                                                                                                                                |
| Address        | <Address contractUrl="https://basescan.org/address/0x88038752750D7717a19F2A681eF75e65Fb714f1E" urlId="8453_0x88038752750D7717a19F2A681eF75e65Fb714f1E" urlClass="erc-token-address"/> |
